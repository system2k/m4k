...
var cameraPos = [11.85, -67.2, -61.12];
var cameraRot = [1.08, -0.68];
var selectX = 0;
var selectY = 0;
var selectZ = 0;
var placeX = 0;
...
function createWsPath() {
	return "ws" + (window.location.protocol == "https:" ? "s" : "") + "://" + window.location.host + "/ws/";
}
...
function makeSocket() {
	socket = new WebSocket(createWsPath());
